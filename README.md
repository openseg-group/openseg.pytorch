...
- 2021/02/05 Support pytorch-1.7, mixed-precision, and distributed training. We also will add more segmentation models that achieve better performance based on the paddlepaddle image pretrained weights.
