...
We achieve **56.02%** on the leaderboard of ADE20K test set based on single model ResNet101 + OCR with any bells or whistles. [ADE20K leaderboard](http://sceneparsing.csail.mit.edu/eval/leaderboard.php)
