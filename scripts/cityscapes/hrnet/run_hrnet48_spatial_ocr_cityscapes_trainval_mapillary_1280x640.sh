...
CHECKPOINTS_NAME="${MODEL_NAME}_${BACKBONE}_${BN_TYPE}_${BATCH_SIZE}_${MAX_ITERS}_1280x640_trainval_mapillary_"$2
LOG_FILE="./log/cityscapes/${CHECKPOINTS_NAME}.log"
                       
PRETRAINED_MODEL="./checkpoints/cityscapes/hrnet48_spatial_ocr_hrnet48_8_100000_1280x640_trainval_1_latest.pth"
