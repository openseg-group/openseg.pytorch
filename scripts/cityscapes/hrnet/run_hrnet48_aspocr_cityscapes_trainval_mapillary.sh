...
CHECKPOINTS_NAME="${MODEL_NAME}_${BACKBONE}_${BN_TYPE}_${BATCH_SIZE}_${MAX_ITERS}_trainval_mapillary_"$2
LOG_FILE="./log/cityscapes/${CHECKPOINTS_NAME}.log"
                       
PRETRAINED_MODEL="./checkpoints/cityscapes/hrnet48_asp_ocr_hrnet48__8_200000_trainval_1_latest.pth"
