...
CHECKPOINTS_NAME="${MODEL_NAME}_${BACKBONE}_${BN_TYPE}_${BATCH_SIZE}_${MAX_ITERS}_trainval_mapillary_coarse_"$2
LOG_FILE="./log/cityscapes/${CHECKPOINTS_NAME}.log"
PRETRAINED_MODEL="./checkpoints/cityscapes/hrnet48_asp_ocr_hrnet48__8_50000_trainval_mapillary_ohem_latest.pth"
