...
CHECKPOINTS_NAME="${MODEL_NAME}_${BACKBONE}_${BN_TYPE}_${BATCH_SIZE}_${MAX_ITERS}_trainval_mapillary_coarse_trainval_"$2
LOG_FILE="./log/cityscapes/${CHECKPOINTS_NAME}.log"
                       
PRETRAINED_MODEL="./checkpoints/cityscapes/hrnet48_asp_ocr_hrnet48__8_50000_trainval_mapillary_coarse_ohem_latest.pth"
...
if [ "$1"x == "train"x ]; then
  ...
  #                      --out_dir ${SAVE_DIR}${CHECKPOINTS_NAME}_val_ms_baseline

  # "baseline": [0.5, 0.75, 1.0, 1.25, 1.5, 1.75] miou=90.0
  cd lib/metrics  
  ${PYTHON} -u cityscapes_evaluator.py --pred_dir ${SAVE_DIR}${CHECKPOINTS_NAME}_val_ms_baseline/label  \
